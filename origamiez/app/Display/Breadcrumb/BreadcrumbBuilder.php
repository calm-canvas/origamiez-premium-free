...
namespace Origamiez\Display\Breadcrumb;

use Origamiez\Display\Breadcrumb\Segments\SegmentInterface;
use Origamiez\Display\Breadcrumb\Segments\HomeSegment;
use Origamiez\Display\Breadcrumb\Segments\ArchiveSegment;
use Origamiez\Display\Breadcrumb\Segments\SearchSegment;
use Origamiez\Display\Breadcrumb\Segments\PageSegment;
use Origamiez\Display\Breadcrumb\Segments\SingleSegment;
use Origamiez\Display\Breadcrumb\Segments\NotFoundSegment;

/**
 * Class BreadcrumbBuilder
 *
 * @package Origamiez\Display\Breadcrumb
 */
class BreadcrumbBuilder {
