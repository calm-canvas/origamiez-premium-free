...
use Origamiez\Security\Sanitizers\SanitizerInterface;
use Origamiez\Security\Sanitizers\CheckboxSanitizer;
use Origamiez\Security\Sanitizers\SelectSanitizer;
use Origamiez\Security\Sanitizers\TextAreaSanitizer;
use Origamiez\Security\Sanitizers\UrlSanitizer;
use Origamiez\Security\Sanitizers\EmailSanitizer;
use Origamiez\Security\Sanitizers\TextSanitizer;

/**
 * Class SanitizationManager
 *
 * @package Origamiez\Security
 */
class SanitizationManager {
