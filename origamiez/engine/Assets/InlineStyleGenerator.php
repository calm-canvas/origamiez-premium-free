...
class InlineStyleGenerator {
	...
	private function build_color_variables(): string {
		...
		$default_colors = array(
			...
			'line_1_bg_color'                      => 'var(--wp--preset--color--secondary, #e8ecf1)',
			'line_2_bg_color'                      => 'var(--wp--preset--color--secondary, #f0f2f5)',
			'line_3_bg_color'                      => 'var(--wp--preset--color--secondary, #f8fafc)',
			'footer_sidebars_bg_color'             => 'var(--wp--preset--color--primary, #222222)',
			'footer_sidebars_text_color'           => 'var(--wp--preset--color--body, #a0a0a0)',
			'footer_sidebars_widget_heading_color' => 'var(--wp--preset--color--heading, #ffffff)',
			'footer_end_bg_color'                  => 'var(--wp--preset--color--primary, #111111)',
			'footer_end_text_color'                => 'var(--wp--preset--color--body, #a0a0a0)',
