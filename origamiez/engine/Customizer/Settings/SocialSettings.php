...
class SocialSettings implements SettingsInterface {
	...
	public function register( CustomizerService $service ): void {
		...
		foreach ( $social_objects as $social_slug => $social ) {
			...
			$service->registerSetting( "{$social_slug}_color", [
