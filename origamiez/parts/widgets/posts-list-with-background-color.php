<?php
/**
 * Origamiez Posts List With Background Color Widget
 *
 * @package Origamiez
 */
...
/**
 * Class Origamiez_Widget_Posts_List_With_Background
 */
class Origamiez_Widget_Posts_List_With_Background extends \Origamiez\Engine\Widgets\AbstractPostsWidgetTypeC {
	/**
	 * Register widget
	 */
	...
	/**
	 * Origamiez_Widget_Posts_List_With_Background constructor.
	 */
	...
	public function widget( $args, $instance ): void {
		...
		if ( $posts->have_posts() ) :
			$loop_index       = 1;
			$col_left_classes = $instance['excerpt_words_limit'] ? 'col-sm-6' : 'col-sm-12';
			while ( $posts->have_posts() ) :
				...
				<article <?php post_class( $post_classes ); ?>>
					<div class="row">
						...
						<?php
						if ( $instance['excerpt_words_limit'] ) :
							?>
